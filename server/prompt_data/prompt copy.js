...
The score should be counted based on percent of statements amount made in the article
and amount of statements with usage of manipulations. (i.e. if there are 42 statements with manipulations out of 100 statements, the score is 58)
...
"score" : 57,
"explanation" : … ,
"sidesScore" :[ { "sideName" : "President", "score" : 92 }, { "sideName" : "Police", "score" : 43 } ],
...
PAY ATTENTION: //DON'T ROUND THE SCORE! Show the exact score based on percent of biased statements out of all statements (i.e 51, 63, 38, etc...). In explanation - explain the score and how it was calculated.
Don't include any text before or after the output JSON object!
`;
