...
const TEXTS = {
    sharingOptions: {
        getHtml: (biasLevel: number, biasLevelText: string) => {
        ...
        getDirectUrl: (biasLevel: number, biasLevelText: string) => {
...
interface DetailsBiasProps {
    biasLevel?: number;
}

export default function DetailsBias({ biasLevel = 1 }: DetailsBiasProps) {
    ...
    const getTitle = (clickedOption: number) => {
