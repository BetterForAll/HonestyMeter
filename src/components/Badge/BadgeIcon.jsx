...
export default function BadgeIcon({
    ...
    return (
        <svg width={width} height={height} viewBox="0 0 512 512">
            <defs>
                <symbol height="512" id="svg_46" width="512">
                    <defs>
                        <symbol height="200px" id="svg_41" viewBox="0 0 512.00 512.00" width="200px">
                            <g id="svg_45" strokeWidth="0" />
                            <g id="svg_44" strokeLinecap="round" strokeLinejoin="round" />
                            <g id="svg_43">
                        ...
                        {
                            showBadgeName &&
                            <symbol height="200px" id="svg_39" width="200px">
                                <defs>
                                    <path d="m50,100a50,50 0 1 1 100,0a50,50 0 1 1 -100,0" fill="none" id="svg_42" />
                                </defs>
                                <text fill={color} fontFamily="Arial" fontSize="14">
                                    <textPath startOffset="0%" href="#svg_42">Honesty Badge</textPath>
                                </text>
                            </symbol>
                        }
                    </defs>
                    <g className="layer">
                        <use id="svg_40" transform="matrix(1.79633 0 0 1.87783 -365.715 -407.233)" x="261.6" href="#svg_41" y="259.49" />
                        <use id="svg_38" transform="matrix(4.05041 0 0 3.81059 -100.444 -66.947)" x="-5.32" href="#svg_39" y="-19.5" />
                    </g>
                </symbol>
            </defs>
            <g className="layer">
                <use id="svg_6" transform="matrix(-26.4558 0 0 24.8274 5301.41 -5005.9)" x="252.92" href="#svg_5" y="287.15" />
                <use id="svg_23" transform="matrix(-14.5833 0 0 -28 -1519.29 -4630)" x="0" href="#svg_22" y="0" />
                <use id="svg_47" transform="matrix(1.02109 0 0 0.973579 -32.1356 9.94736)" x="1.02" href="#svg_46" y="15.53" />
            </g>
        </svg>
    );
}
