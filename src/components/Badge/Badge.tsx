...
interface BadgeProps {
    ...
    isMenu?: boolean;
    isTooltipShownOnDesktop?: boolean;
...
export default function Badge({
    ...
    const { color, secondaryColor, texts, icon } = SETTINGS[biasLevel as keyof typeof SETTINGS] || SETTINGS[0];
    ...
    const badgeContent = (
        ...
        >
            {isMenu ? (
                ...
                <Image src={icon || '/badge.svg'} alt="Balance Icon" className="" width={140} height={140} />
            )}
        ...
        <TooltipProvider>
            <Tooltip open={isTooltipOpen} onOpenChange={setTooltipOpen}>
                ...
                <TooltipContent side={tooltipPlacement} className="text-center p-2">
                    <TooltipContentBody 
                        tooltip={tooltip as TooltipText}
...
const TooltipContentBody = ({ tooltip, showFullTooltip, tooltipPlacement }: TooltipContentBodyProps) => {
