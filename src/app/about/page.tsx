...
const ARTICLE_URL =
  "https://martechseries.com/predictive-ai/ai-platforms-machine-learning/honestymeter-ai-powered-pioneer-for-unbiased-media-integrity-and-transparency";
const VIDEO_URL = "https://player.vimeo.com/video/820300228";

export const metadata: Metadata = {
  title: "HonestyMeter (Honesty Meter)",
  description:
    "HonestyMeter - A Free Open Source Framework for Bias and Manipulation Detection in Media Content",
  alternates: {
    canonical: PAGE_ABSOLUTE_URL.ABOUT,
  },
};
  ...
  return (
    <main className="max-w-[1000px] p-8 mx-auto text-gray-900 border-none">
      ...
      <p className="italic text-lg text-gray-500 mb-10">
        ...
        <a
          href={ARTICLE_URL}
          className="no-underline text-indigo-600"
          target="_blank"
        >
      ...
      <h2 id="introduction" className="text-2xl mt-8 mb-4">
        {TEXTS.introduction.title}
      </h2>
      <h3 className="text-xl font-bold mt-6 mb-2">
        Understanding HonestyMeter Through a Joke
      </h3>
      <p className="mb-4">{TEXTS.introduction.joke}</p>
      <h3 className="text-xl font-bold mt-6 mb-2">Truth Distortion</h3>
      <p className="mb-4">
        This anecdote underscores the type of misleading factual representation
        that HonestyMeter is designed to address –
        <b>
          true statements framed in a context that can completely distort their
          intended meaning
        </b>
        . This distortion is often achieved through sophisticated manipulation
        techniques such as sensationalism, framing, selective reporting, and
        many others, which can be applied either intentionally or unknowingly.
        These tactics can lead audiences to form distorted perceptions of
        reality, hindering their ability to make well-informed decisions.
        HonestyMeter aims to detect and clearly expose these tactics, assisting
        journalists in creating more objective content and empowering audiences
      ...
      <p className="mb-4">{TEXTS.introduction.problemNote}</p>
      <h3 className="text-xl font-bold mt-6 mb-2">
        Introducing HonestyMeter: A Tool for Enhancing Media Objectivity and
        Transparency
      </h3>
      <p className="mb-4">{TEXTS.introduction.solution}</p>
      <h3 className="text-xl font-bold mt-6 mb-2">
      ...
      <ul className="pl-0 list-none">
        <li className="mb-4">
          <h4 className="font-bold">
            Specialized Focus on Manipulations in Factual Information
            Presentation
          </h4>
          <p>
            Unlike basic fact-checking and bias/sentiment analysis tools,
            HonestyMeter focuses on sophisticated media manipulations. It
            detects how{" "}
            <b> factual information is presented in misleading contexts</b>,
            including the use of omission, framing, misleading headlines, and
            other similar techniques, which can lead to significant distortions
            of reality.
          </p>
        </li>
        <li className="mb-4">
          ...
          <p>
            It offers cost-free access and its source code is publicly
            available, promoting transparency, wider accessibility, and
        ...
        <li className="mb-4">
          ...
          <p>
            HonestyMeter harnesses both AI and user feedback, continually
            refining its capability to identify and analyze media manipulations.
          </p>
        </li>
      </ul>

      <p className="mb-4">
        These features establish HonestyMeter as a unique entity in media
        analysis, addressing complexities beyond the scope of typical media
        analysis tools.
      </p>
      <h3 id="features" className="text-xl font-bold mt-6 mb-2">
        Features:
      </h3>
      <p className="mb-4">
        Our initial release focused on a singular feature, allowing users to
        copy text and receive a bias report. Below are the newly added features
        we have released in the past few months:
      </p>
      <ul className="pl-0 list-none">
        <li className="mb-4">
          <p>
            <b>News Integrity Feed</b> (New Release): Offers analysis of the
            latest news from leading sources. Users can search by keyword or
            filter by category and country.
          </p>
        </li>
        <li className="mb-4">
          <p>
            <b>Personal News Integrity Feed for Popular People</b> (New
            Release): Analyzes the latest news about famous people. Users can
            search by name
          </p>
        </li>
        <li className="mb-4">
          <p>
            <b>Ratings</b> (New Release): Features ratings for the most praised
            and criticized people, located on the &quot;People&quot; page, and
            ratings for the most objective sources, available on the homepage.
          </p>
        </li>
        <li className="mb-4">
          <p>
            <b>Custom Content Analysis</b> (New Release - now with Link
            Support): Users can submit links or text to receive a comprehensive
            bias report. This feature enables analysis of content not featured
            on our website and allows authors to reduce bias in their original
            content.
          </p>
        </li>
        <li className="mb-4">
          <p>
            <b>Honesty Badge</b> (New Release): Users who share our vision of
            transparent, unbiased media can display our badge alongside any
            content they post on platforms or social networks they manage or
            use. This enhances trust and engagement with the content. Each share
            promotes media transparency awareness, contributing to a fairer
            world.
          </p>
          <p>There are three types of badges:</p>
          <ul className="pl-0 list-none mt-2">
            <li className="mb-2">
              <p>
                General Badge - Demonstrates support for transparent, unbiased
                media. Can be used with any content, anywhere.
              </p>
            </li>
            <li className="mb-2">
              <p>
                Fair Content Badge - For authors or publishers of content that
                has achieved a high objectivity score and wish to highlight the
                objectivity of their content.
              </p>
            </li>
            <li className="mb-2">
              <p>
                Medium and High Bias Badges - For publishers who wish to openly
                indicate the bias level in their content, thereby demonstrating
                extreme transparency. These badges are used in conjunction with
                the Fair Content Badge.
              </p>
            </li>
          </ul>
        </li>
        <li className="mb-4">
          <p>
            <b>Auto-Optimization Based on User Feedback</b> (New Release): This
            feature transforms HonetyMeter into a{" "}
            <b>self-optimizing system</b>, utilizing a blend of AI bias
            &apos;experts&apos; and user feedback. Users have the ability to
            click on any section of the bias report and submit their feedback.
            This feedback is then reviewed by the AI. If the feedback is
            accepted, the report is updated accordingly, and the data is
            utilized for training and enhancing the model, thereby enabling
            continuous improvement in the accuracy of the reports.
          </p>
        </li>
      </ul>

      <h3 id="current-state" className="text-xl font-bold mt-6 mb-2">
        Current State and Updates:
      </h3>
      <ul className="pl-0 list-none">
        <li className="mb-2">
          <p>Over 18,000 reports generated.</p>
        </li>
        <li className="mb-2">
          <p>Hundreds of new reports added daily.</p>
        </li>
        <li className="mb-2">
          <p>
            Extensive coverage for each of the most popular people, e.g., over
            500 reports on Elon Musk, Donald Trump and Taylor Swift among
            others.
          </p>
        </li>
        <li className="mb-2">
          <p>
            Over 140 links from multiple websites in various languages,
            including listings and upvotes in leading AI tool indexes.
          </p>
        </li>
        <li className="mb-2">
          <p>
            Surprisingly, HonestyMeter is used in multiple languages, despite
            being primarily English-focused.
          </p>
        </li>
        <li className="mb-2">
          <p>
            The current version is an experimental demo. We&apos;re developing a
            more sophisticated version with higher accuracy and consistency.
            Nonetheless, even in its current form, HonestyMeter often provides
            insights difficult for humans to detect.
          </p>
        </li>
      </ul>
      <h2 className="text-2xl mt-8 mb-4">Technical Details</h2>

      <h3 id="process" className="text-xl font-bold mt-6 mb-2">
        {TEXTS.process.title}
      </h3>
      <p className="mb-4">{TEXTS.process.description}</p>
      <ol className="list-decimal pl-6 mb-4">
        <li className="mb-2">
          <p>{TEXTS.process.input}</p>
        </li>
        <li className="mb-2">
          <p>{TEXTS.process.analysis}</p>
        </li>
        <li className="mb-2">
          <p>{TEXTS.process.scoring}</p>
        </li>
        <li className="mb-2">
          <p>{TEXTS.process.reporting}</p>
        </li>
        <li className="mb-2">
          <p>{TEXTS.process.feedback}</p>
        </li>
        <li className="mb-2">
          <p>{TEXTS.process.improvment}</p>
        </li>
      </ol>
      ...
      <div className="flex flex-col justify-center items-center mt-8">
        <h2 id="example" className="text-2xl mb-4">
          {TEXTS.exampleReport}
        </h2>
        <p className="mb-2">({TEXTS.aiGeneratedArticle})</p>
        <Image
          src={exampleReport}
      ...
      <h2 id="future-plans" className="text-2xl mt-8 mb-4">
        {TEXTS.futurePlans.title}
      </h2>
      <p className="mb-4">{TEXTS.futurePlans.supportVideoandAudio}</p>
      <h3 id="thanks" className="text-xl font-bold mt-6 mb-2">
        {TEXTS.thankYou.specialThanks}
      </h3>
      <p className="mb-4">
        <a
          href={TEXTS.thankYou.oneLittleCoder.link}
        ...
        <a
          href={TEXTS.thankYou.yoheiNakajima.link}
          className="text-indigo-600"
          target="_blank"
        >
        ...
        <a
          href={TEXTS.thankYou.mattWolfe.link}
          className="text-indigo-600"
          target="_blank"
        >
      ...
      <p className="mb-4">{TEXTS.thankYou.aiResearches}</p>
      <p className="mb-4">
        {TEXTS.thankYou.openAi}
        <a href="https://openai.com" className="text-indigo-600" target="_blank">
          {TEXTS.thankYou.openAiLinkText}
        </a>
      ...
      <p className="mb-4">{TEXTS.importantConsidirations.p1}</p>
      <p className="mb-4">{TEXTS.importantConsidirations.p2}</p>
      <h2 id="conclusion" className="text-2xl mt-8 mb-4">
        {TEXTS.conclusion.title}
      </h2>
      <p className="mb-4">{TEXTS.conclusion.gameChanger}</p>
      <h2 id="join-us" className="text-2xl mt-8 mb-4">
        Join Us in Shaping the Future of Media Truth
      </h2>
      <p className="mb-4">
        Up to this day, HonestyMeter has been fully self-funded. We invest our
        own time and money in research, development, and maintenance. Though we
        are fully capable of progressing independently, we are open to the
        possibility of partnering with those who resonate with our vision and
        can offer a substantial contribution, whether it be enhancing
        visibility, funding collaborations, or offering expertise.
        <br /> <br />
        If you share our vision of truthful media and are interested in making a
        contribution that has the potential for major advancement, please feel
        free to reach out to us at&nbsp;
        <a href="mailto:info@honestymeter.com" className="text-indigo-600">
          info@honestymeter.com
        </a>
        .
        <br /> <br />
        Together, we can let the truth triumph.
      </p>
      <h3 id="disclosure" className="text-xl font-bold mt-6 mb-2">
        {TEXTS.disclosure.title}
      </h3>
      ...
      <Share 
        ...
        url="https://honestymeter.com/about"
